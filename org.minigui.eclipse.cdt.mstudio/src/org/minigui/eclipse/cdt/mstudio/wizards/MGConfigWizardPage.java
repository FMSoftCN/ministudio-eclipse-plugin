...
public class MGConfigWizardPage extends WizardPage {
	...
	public static final String PAGE_ID = "org.minigui.eclipse.cdt.mstudio.wizard.MGConfigWizardPage"; //$NON-NLS-1$

	private static final Image IMG = ManagedBuilderUIImages.get(ManagedBuilderUIImages.IMG_BUILD_CONFIG);
	private static final String TITLE = MiniGUIMessages.getString("CConfigWizardPage.0"); //$NON-NLS-1$
	private static final String MESSAGE = MiniGUIMessages.getString("CConfigWizardPage.1"); //$NON-NLS-1$
	private static final String COMMENT = MiniGUIMessages.getString("CConfigWizardPage.12"); //$NON-NLS-1$
	...
	public MGConfigWizardPage(MGWizardHandler h) {
        super(MiniGUIMessages.getString("MGConfigWizardPage.0")); //$NON-NLS-1$
	...
	public void createControl(Composite p) {
		...
		setupLabel(c1, MiniGUIMessages.getString("CConfigWizardPage.4"), GridData.BEGINNING); //$NON-NLS-1$
		l_projtype = setupLabel(c1, EMPTY_STR, GridData.FILL_HORIZONTAL);
		setupLabel(c1, MiniGUIMessages.getString("CConfigWizardPage.5"), GridData.BEGINNING); //$NON-NLS-1$
		l_chains = setupLabel(c1, EMPTY_STR, GridData.FILL_HORIZONTAL);
		setupLabel(c1, MiniGUIMessages.getString("CConfigWizardPage.6"), GridData.BEGINNING); //$NON-NLS-1$
		...
		b1.setText(MiniGUIMessages.getString("CConfigWizardPage.7")); //$NON-NLS-1$
		...
		b2.setText(MiniGUIMessages.getString("CConfigWizardPage.8")); //$NON-NLS-1$
		...
		b3.setText(MiniGUIMessages.getString("CConfigWizardPage.13")); //$NON-NLS-1$
	...
	static public CfgHolder[] getDefaultCfgs(MGWizardHandler handler) {
		...
		for (IToolChain tc : handler.getSelectedToolChains()){
			CfgHolder[] cfgs = null;
			if (id != null) 
				cfgs = CfgHolder.cfgs2items(ManagedBuildManager.getExtensionConfigurations(tc, MGWizardHandler.ARTIFACT, id));
			else if (pt != null) 
