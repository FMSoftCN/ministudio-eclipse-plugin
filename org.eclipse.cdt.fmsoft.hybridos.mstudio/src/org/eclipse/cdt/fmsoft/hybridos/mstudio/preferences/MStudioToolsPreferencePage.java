...
class MsVersionListener extends SelectionAdapter
{
	...
	private MStudioToolsPreferencePage m_prefpage;
	...
	{
		if (m_control == ADD) {
			MStudioVersionWizard versionWizard = new MStudioVersionWizard(MStudioMessages.getString("MStudioVersionWizard.add.title"));
			...
			MStudioVersionWizard versionWizard = new MStudioVersionWizard(MStudioMessages.getString("MStudioVersionWizard.edit.title"));
			WizardDialog versionDialog = new WizardDialog(m_prefpage.getShell(), versionWizard);
			versionDialog.create();
...
public class MStudioToolsPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public static String[] getMStudioVersions() {
		...
		for (int i=0; i<count; ++i) {
			String name = MStudioPreferenceConstants.MSVERSION_NAME + "." + Integer.toString(i);
	...
	public static String getMStudioBinPath(String version) {
		...
		int count = store.getInt(MStudioPreferenceConstants.MSVERSION_COUNT);
		for (int i=0; i<count; ++i) {
			String nameKey = MStudioPreferenceConstants.MSVERSION_NAME + "." + Integer.toString(i);
			String binpathKey = MStudioPreferenceConstants.MSVERSION_BINPATH + "." + Integer.toString(i);
			String name = "";
			String binpath = "";
	...
	public boolean performOk()
	{
		...
		for (int i=0; i<table.getItemCount(); ++i) {
			store.setValue(MStudioPreferenceConstants.MSVERSION_NAME + "." + Integer.toString(i),
					table.getItem(i).getText(0));
			store.setValue(MStudioPreferenceConstants.MSVERSION_BINPATH + "." + Integer.toString(i),
